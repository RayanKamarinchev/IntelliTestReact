...
namespace IntelliTest.Core.Services
{
    public class TestResultsService : ITestResultsService
    {
        ...
        public int[] GetExaminersIds(int testId)
        {
        ...
        public async Task<List<TestStatsViewModel>> TestsTakenByClass(int classId)
        {
        ...
        public async Task<TestReviewViewModel> GetStudentsTestResults(int testId, int studentId)
        {
        ...
        public async Task<IEnumerable<TestResultsViewModel>> GetStudentsTestsResults(int studentId)
        {
        ...
        public async Task SubmitTestScore(int testId, int studentId, TestReviewViewModel scoredTest)
        {
            var openQuestionAnswers = await context.OpenQuestionAnswers
                                                   .Include(q => q.Question)
                                                   .Where(q => q.StudentId == studentId
