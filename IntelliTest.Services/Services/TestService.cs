...
namespace IntelliTest.Core.Services
{
    public class TestService : ITestService
    {
        ...
        public async Task<QueryModel<TestViewModel>> Filter(IQueryable<Test> testQuery, QueryModel<TestViewModel> query, int? teacherId, int? studentId)
        {
        ...
        public async Task<QueryModel<TestViewModel>> GetAll(int? teacherId, int? studentId, QueryModel<TestViewModel> query)
        {
        ...
        public async Task<QueryModel<TestViewModel>> GetMy(int? teacherId, int? studentId, QueryModel<TestViewModel> query)
        {
            var testQuery = context.Tests
                                   .Include(t => t.TestResults)
                                   .Include(t => t.TestLikes)
        ...
        public async Task<bool> IsTestTakenByStudentId(int testId, int studentId)
        {
            return context.TestResults.Any(t => t.StudentId == studentId && t.TestId == testId);
        }


        public async Task<QueryModel<TestViewModel>> TestsTakenByStudent(int studentId, QueryModel<TestViewModel> query)
        {
        ...
        public async Task<int> Create(TestViewModel model, int teacherId, string[] classNames)
        {
            Test test = new Test()
            {
                Title = model.Title,
        ...
        public async Task<bool> StudentHasAccess(int testId, int studentId)
        {
